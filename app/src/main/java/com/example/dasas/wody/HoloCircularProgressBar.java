...
public class HoloCircularProgressBar extends View {
    ...
    private float mMarkerProgress2 = 0.0f;
    ...
    protected void onDraw(final Canvas canvas) {
        ...
        if (isThumbEnabled()) {
            ...
            mSquareRect.left = mThumbPosX - mThumbRadius / 2;
            mSquareRect.right = mThumbPosX + mThumbRadius / 2;
            mSquareRect.top = mThumbPosY - mThumbRadius / 2;
            mSquareRect.bottom = mThumbPosY + mThumbRadius / 2;
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        bundle.putFloat(INSTANCE_STATE_MARKER_PROGRESS, mMarkerProgress2);
     ...
     */
    public float getMarkerProgress() { return mMarkerProgress;
    }
    public float getMarkerProgress2() {
        return mMarkerProgress2;
    }
    ...
    public void setMarkerProgress2(final float progress) {
        mIsMarkerEnabled = true;
        mMarkerProgress2 = progress;
    }
    ...
    private void updateMarkerColor() {
        ...
        mMarkerColorPaint.setColor(Color.WHITE);
